...
if [ -d libraries/libpng-1.6.58 ]; then rm -fr libraries/libpng-1.6.58; fi;
if [ -d libraries/freetype-VER-2-13-3 ]; then rm -fr libraries/freetype-VER-2-13-3; fi;
if [ -d libraries/hdf5-1.14.6 ]; then rm -fr libraries/hdf5-1.14.6; fi;
if [ -d libraries/fftw-3.1.2 ]; then rm -fr libraries/fftw-3.1.2; fi;
if [ -d libraries/expat-2.8.2 ]; then rm -fr libraries/expat-2.8.2; fi;
