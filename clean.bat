...
IF EXIST libraries\zlib-1.3.1 rmdir /s /q libraries\zlib-1.3.1
IF EXIST libraries\libgd-2.1.0alpha rmdir /s /q libraries\libgd-2.1.0alpha
IF EXIST libraries\libpng-1.6.58 rmdir /s /q libraries\libpng-1.6.58
IF EXIST libraries\freetype-VER-2-13-3 rmdir /s /q libraries\freetype-VER-2-13-3
IF EXIST libraries\hdf5-1.14.6 rmdir /s /q libraries\hdf5-1.14.6
IF EXIST libraries\fftw-3.1.2 rmdir /s /q libraries\fftw-3.1.2
IF EXIST libraries\expat-2.8.2 rmdir /s /q libraries\expat-2.8.2
